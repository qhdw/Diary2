...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.addNote).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        ...
                        in.setClassName(getApplicationContext(),"com.example.diary2.NoteEditActivity");
                        startActivity(in);
                    }
                }
        );
        ...
        SimpleCursorAdapter adapter=new SimpleCursorAdapter(MainActivity.this,R.layout.note_item,listItemCursor,new String[]{"_id","title","author","createTime"},new int[]{R.id.noteId,R.id.noteTitle,R.id.noteAuthor,R.id.noteCreateTime}, CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
    ...
    private void initListNoteListener() {
        ...
        ((ListView)this.findViewById(R.id.listNote)).setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, final long id) {
                new AlertDialog.Builder(MainActivity.this).setTitle("提示框").setMessage("确认删除日记？").setPositiveButton("确定",new DialogInterface.OnClickListener() {
                    @Override
        ...
        ((ListView) this.findViewById(R.id.listNote)).setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent in=new Intent();
                in.setClassName(view.getContext(),"com.example.diary2.NoteEditActivity");
